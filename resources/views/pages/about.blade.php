<x-landing-layout>
 ...
 <!-- rounded-t-[40px] -->
    <div style="background-image: url('{{ asset('images/banner/light-bg.jpg') }}');" class="w-full p-10 mt-6 bg-no-repeat bg-cover rounded-[40px] max-w-[1200px] w-[90%] mx-auto">
<h3 class="text-xl md:text-2xl text-black leading-9 md:leading-[40px]">MEDIHOME Care Services are passionate about delivering quality services of an extremely high standard as if it were our loved ones receiving care and support. Allow our multidisciplinary Medihome team provide in-house services for your loved ones. </h3>
<h3 class="text-xl md:text-2xl text-black leading-9 md:leading-[40px]"> During the Coronavirus pandemic, especially the lockdowns, we were able to provide outstanding quality care for our customers in accordance with covid protocol, both existing and new. We ensured staff are fully protected against the Coronavirus, with personal protective clothing, sanitizer, weekly covid tests, training, policies ... </h3> 
<h3 class="text-xl md:text-2xl text-black leading-9 md:leading-[40px]">No Wonder MEDIHOME is recognised as one of the best and top home care providers. We have a proven track records, reputation and are rated as consistent by Homecare service providers in Nigeria.</h3>
    </div>

    <div class="p-10 mt-6 mx-auto h-full max-w-[1200px] w-[90%] mx-auto rounded-[40px] grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
...
<div class="bg-no-repeat bg-cover p-10 mt-10 mb-10 mx-auto max-w-[1200px] w-[90%] mx-auto rounded-[40px] text-white" style="background-image: url('{{ asset('images/banner/dark-bg.svg') }}');" >
